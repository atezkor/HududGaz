...
Route::get('/', function() {
    return redirect()->route('director.organs');
});
...
Route::get('tech_conditions', [App\Http\Controllers\DirectorController::class, 'tech_conditions'])->name('director.tech_conditions');
