                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" name="lastname" id="lastname" class="form-control"
                                                   value="{{$model->lastname}}" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" name="patronymic" id="patronymic"
                                                   class="form-control" value="{{$model->patronymic}}"
                                                   autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="text" name="position" id="position" class="form-control"
                                                   value="{{$model->position}}" autocomplete="off">
                                        </div>
                                    </div>
                                ...
                                <div id="extra" class="tap-pane fade">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input type="password" name="old_pass" id="old_pass"
                                                   value="{{old('old_pass')}}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="confirm_pass"
                                               class="col-2">@lang('global.profile.confirm_pass')</label>
                                        <div class="col-10">
                                            <input type="password" name="confirm_pass" id="confirm_pass"
                                                   value="{{old('confirm_pass')}}" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
