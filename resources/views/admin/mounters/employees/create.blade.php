                        ...
                        <form action="{{$action}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="statement_number"
                                           class="col-2">{{__('admin.mounter.stat_number')}}</label>
                                    <div class="col-10">
                                        <input type="number" name="statement_number" id="statement_number"
                                               value="{{$model->statement_number}}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" name="second_name" id="second_name"
                                               value="{{$model->second_name}}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" name="last_name" id="last_name" value="{{$model->last_name}}"
                                               class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="diploma_number"
                                           class="col-2">{{__('admin.mounter.diploma_number')}}</label>
                                    <div class="col-10">
                                        <input type="number" name="diploma_number" id="diploma_number"
                                               value="{{$model->diploma_number}}" class="form-control">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="passport_series"
                                           class="col-2">{{__('admin.mounter.passport_series')}}</label>
                                    <div class="col-10">
                                        <input type="text" name="passport_series" id="passport_series"
                                               value="{{$model->passport_series}}" class="form-control">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="specialization"
                                           class="col-2">{{__('admin.mounter.specialized')}}</label>
                                    <div class="col-10">
                                        <input type="text" name="specialization" id="specialization"
                                               value="{{$model->specialization}}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" name="experience" id="experience"
                                               value="{{$model->experience}}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="date" name="date_contract" id="date_contract"
                                               value="{{$model->date_contract}}" class="form-control">
                                    </div>
                                    <div class="col-6">
                                        <label for="date_contract_end">{{__('admin.mounter.date_contract_end')}}</label>
                                        <input type="date" name="date_contract_end" id="date_contract_end"
                                               value="{{$model->date_contract_end}}" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="card-footer">
                                ...
                                <div class="float-right">
                                    <a href="{{route('admin.mounter.employees.index', ['firm' => $firm_id ?? $model->firm_id])}}"
                                       class="btn btn-outline-secondary">{{__('global.btn_back')}}</a>
                                    <button type="reset" id="reset"
                                            class="btn btn-default float-right">{{__('global.btn_reset')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
