                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-6 pr-5">
                                    ...
                                    <input type="date" name="date_created" id="date_created" value="{{$model->date_created}}" class="form-control date">
                                </div>
                                <div class="form-group col-6 pl-5">
                                    <label for="date_expired">{{__('admin.date_expired')}}</label>
                                    <input type="date" name="date_expired" id="date_expired" value="{{$model->date_expired}}" class="form-control date">
                                </div>
                            </div>
