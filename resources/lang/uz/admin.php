...
return [
    ...
    'org_director' => "Tashkilot rahbari",
    'period_activity' => "Faoliyat davri",
    'date_registry' => "Ro\u{2018}yxatga olingan sana",
    'date_expiry' => "Amal qilish muddati (gacha)",
    'license' => "Tashkilotning rasmiy hujjatini yuklang",
    'doc_upload' => "Hujjatni yuklang",
    'document' => "Tashkilotning rasmiy hujjati",
    ...
    'mounter' => [
        ...
        'district' => "Tashkilot joylashgan tuman (shahar)",
        'address' => "Tashkilot manzili (qayerda joylashgan)",
        'tin' => "Soliq uchun STIR raqami",
        'given_by' => "Kim tomonidan berilgan",
        'permissions' => "Ruxsat etilgan",
        'implementations' => "Amalga oshiriladi",
        'alert_title' => "Tashkilotni o\u{2018}chirib tashlamoqchimisiz?",
        'btn_new' => "Tashkilot qo\u{2018}shish",
